...
--filter-udp=3478-3482,3484,3488,3489,3491-3493,3495-3497,%GameFilter% --ipset="%LISTS%ipset-whatsapp.txt" --ipset-exclude="%LISTS%ipset-exclude.txt" --dpi-desync=fake --dpi-desync-autottl=2 --dpi-desync-repeats=10 --dpi-desync-any-protocol=1 --dpi-desync-fake-unknown-udp="%BIN%quic_initial_www_google_com.bin" --dpi-desync-cutoff=n2
